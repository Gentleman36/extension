...
(function() {
    ...
    async function initialize() {
        ...
        const uiCreationObserver = new MutationObserver(() => {
            ...
            if (inputArea && !document.getElementById('analyzer-controls-container')) {
                console.log("Analyzer: Input area found. Creating UI.");
                createUI();
                setupAutoAnalyzerObserver();
                uiCreationObserver.disconnect(); // Self-destruct after success
            }
        });
    ...
    function setupAutoAnalyzerObserver() {
        ...
        const autoAnalyzeObserver = new MutationObserver(() => {
        ...
        // This observer just finds the chat container to attach the main one
